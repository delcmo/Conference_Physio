...
% Note that there is a slight slope discontinuity in the outlet pressure profile (\fig{fig:Pressure}) using SUPG; this discontinuity is not present when employing the entropy-viscosity method.
